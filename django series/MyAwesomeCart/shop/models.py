...
class Product(models.Model):
    ...
    category = models.CharField(verbose_name=(
        "Category"), max_length=50, default='')
    sub_category = models.CharField(verbose_name=(
        "Sub-Category"), max_length=50, default='')
    ...
    image = models.ImageField(verbose_name=(
        "Image"), upload_to='shop/images', default='')
